...
# Separar as linhas
linhas = texto_variaveis.strip().split('\n')

# Extrair a primeira "palavra" (nome da variável) de cada linha
vars_extraidas = [linha.split()[0] for linha in linhas if linha.strip()]

print(vars_extraidas)
